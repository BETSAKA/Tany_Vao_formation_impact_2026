...
```{r}
library(ggplot2)
# Création préalable de données simulées AP_superficie_annees
AP_superficie_annees <- data.frame(
  an_creation = 1990:2020,
  superficie_cumulee = cumsum(runif(31, 50, 500))
)
```
